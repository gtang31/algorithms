...
python -mtimeit -s'from dynamic_programming.triple_steps import ThreeStepSolution' 'ThreeStepSolution().recursive(30)'
python -mtimeit -s'from dynamic_programming.triple_steps import ThreeStepSolution' 'ThreeStepSolution().top_down(30)'
"""
    ...
    def top_down(self, N):
        ...
        def recurse(N):
            if N < 0:
                ...
                # add answer to the cache as we go. When we go back up the
                # call-stack, we can find the answer in the cache
